...
| [T-WEB-08](T-WEB-08-model-admin.md) | 模型管理页(增删改/默认/用户路由,key 脱敏) | T-WEB-02 + M8 后端 | 🟢 可交 Codex(后端就绪) |
| [T-WEB-09](T-WEB-09-connectors.md) | 插件/连接器管理页(MCP,状态/作用域,env 不回显) | T-WEB-02 + M10 后端 | 🟢 可交 Codex(后端就绪) |
| [T-WEB-10](T-WEB-10-skills.md) | 技能页(启停 + 管理 + GitHub 导入) | T-WEB-02 + M11 后端 | 🟢 可交 Codex(后端就绪) |
